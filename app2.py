...
def home():
    ...
    try:
        ...
        return render_template('index.html',message="image not uploaded sucessfully")
    ...
    if matches:
        ...
        return render_template("index.html",message="matches found",image_urls=image_urls)
    else:
        return render_template("index.html",message="matches not",image_urls="NULL")
